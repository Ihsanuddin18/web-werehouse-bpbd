...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <!-- ===== template landing pages yang telah jadi biruu ===== -->
...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="{{ asset('landingpages')}}/public/assets/images/favicon.svg"
      type="image/svg"
    />

    <!-- ===== All CSS files ===== -->
    <link rel="stylesheet" href="{{ asset('landingpages')}}/public/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="{{ asset('landingpages')}}/public/assets/css/animate.css" />
    <link rel="stylesheet" href="{{ asset('landingpages')}}/public/assets/css/lineicons.css" />
    <link rel="stylesheet" href="{{ asset('landingpages')}}/public/assets/css/ud-styles.css" />
  </head>
  <body>
          ...
          <div class="col-lg-12">
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand" href="/">
                <img src="{{ asset('landingpages')}}/public/assets/images/logo/logo.svg" alt="Logo" />
              </a>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
              <img src="{{ asset('landingpages')}}/public/assets/images/hero/hero-image.svg" alt="hero-image" />
              <img
                src="{{ asset('landingpages')}}/public/assets/images/hero/dotted-shape.svg"
                alt="shape"
                class="shape shape-1"
              />
              <img
      ...
      <div class="container">
        <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
          ...
          <div class="ud-about-image">
            <img src="{{ asset('landingpages')}}/public/assets/images/about/about-image.svg" alt="about-image" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="faq" class="ud-faq">
      <div class="shape">
        <img src="{{ asset('landingpages')}}/public/assets/images/faq/shape.svg" alt="shape" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            >
              ...
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="{{ asset('landingpages') }}/public/assets/images/testimonials/author-01.png"
                    alt="author"
                  />
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="{{ asset('landingpages') }}/public/assets/images/testimonials/author-02.png"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="{{ asset('landingpages')}}/public/assets/images/testimonials/author-03.png"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
        ...
        <div class="row">
            ...
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('landingpages') }}/public/assets/images/team/team-01.png" alt="team" />
                </div>

                <img
                  src="{{ asset('landingpages') }}/public/assets/images/team/dotted-shape.svg"
                  alt="shape"
                  class="shape shape-1"
                />
                <img
                  src="{{ asset('landingpages') }}/public/assets/images/team/shape-2.svg"
                  alt="shape"
                  class="shape shape-2"
                />
              </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".15s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('landingpages') }}/public/assets/images/team/team-02.png" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".2s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('landingpages') }}/public/assets/images/team/team-03.png" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".25s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('landingpages') }}/public/assets/images/team/team-04.png" alt="team" />
                </div>
    ...
    <footer class="ud-footer wow fadeInUp" data-wow-delay=".15s">
      <div class="shape shape-1">
        <img src="{{ asset('landingpages') }}/public/assets/images/footer/shape-1.svg" alt="shape" />
      </div>
      <div class="shape shape-2">
        <img src="{{ asset('landingpages') }}/public/assets/images/footer/shape-2.svg" alt="shape" />
      </div>
      <div class="shape shape-3">
        <img src="{{ asset('landingpages') }}/public/assets/images/footer/shape-3.svg" alt="shape" />
      </div>
    ...
    <script src="{{ asset('landingpages') }}/public/assets/js/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('landingpages') }}/public/assets/js/wow.min.js"></script>
    <script src="{{ asset('landingpages') }}/public/assets/js/main.js"></script>
    <script>
      // ==== for menu scroll
